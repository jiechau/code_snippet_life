...
| [astro_score/astro-bookmark.html](astro_score/astro-bookmark.html) | Not a demo of anything here: a plain list of the outside pages worth a look before driving out — two light-pollution maps ([lightpollutionmap.info](https://www.lightpollutionmap.info/), [lightpollutionmap.app](https://lightpollutionmap.app/zh-tw/)), NCDR 即時降雨預警, and CWA 雷達回波圖 / 一週 / 降水預報. No form, no request, no script; it shares none of the demo pages' machinery. |
