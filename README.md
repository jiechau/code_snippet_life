...
The two `astro_score/` pages offer a third way to fill 輸入, beside typing and the
GPS: **🗺️ 在地圖上點選 (pick on the map)** opens an OpenStreetMap map over the page,
